<?php
/**
 * Snippet: TennisPro Cart
 * Shortcode: [tennispro_cart]
 * Description: AJAX-powered shopping cart with quantity controls and order summary.
 */

add_shortcode( 'tennispro_cart', function () {
    ob_start();
