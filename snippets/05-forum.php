<?php
/**
 * Snippet: TennisPro Forum
 * Shortcode: [tennispro_forum]
 * Description: Discussion forum – create posts, list all posts, AJAX login modal.
 */

add_shortcode( 'tennispro_forum', function () {
    ob_start();
