<?php
/**
 * Admin Dashboard – full tab-based interface.
 * Rendered via template_redirect in functions.php.
 * Tabs: Dashboard, Products JSON, Recruitment, All Users, All Orders.
 */
...
<div class="admin-tab-panel" id="panel-recruitment" style="display:none;">
    <section class="admin-panel">
        ...
        <?php if ( $job_applications ) : ?>
            ...
            <table class="admin-table">
                <thead>
                    <tr><th>ID</th><th>Name</th><th>Email</th><th>Phone</th><th>Position</th><th>Submitted</th><th>Cover Letter</th><th>CV</th><th>Status</th></tr>
                </thead>
                <tbody>
