<?php
/**
 * Template Name: Recruitment / Careers (Capstone)
 * Job application: Full Name, Email, Phone, Position, Cover Letter, CV upload (.pdf, .doc, .docx).
 * Saves to wp_job_applications; file to /wp-content/uploads/cv_uploads/.
 */
...
?>
<h1>Careers at TennisPro Hub</h1>
<p>Apply with your CV (PDF, DOC or DOCX only).</p>
...
<form method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="cv_upload">CV / Resume (PDF, DOC or DOCX only)</label>
